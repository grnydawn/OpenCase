...
from oc_utils import pathname, Logger # OC addition
...
class Assignment(GeneralAssignment):
    f2003_class = Fortran2003.Assignment_Stmt # OC addition
    pass

class PointerAssignment(GeneralAssignment):
    f2003_class = Fortran2003.Pointer_Assignment_Stmt # OC addition
    pass
...
class Call(Statement):
    ...
    Call instance has attributes:
      ...
      arg_list
    """
    f2003_class = Fortran2003.Call_Stmt # OC addition
...
class Goto(Statement):
    ...
    GO TO <label>
    """
    f2003_class = Fortran2003.Goto_Stmt # OC addition
...
class ComputedGoto(Statement):
    ...
    """
    f2003_class = Fortran2003.Computed_Goto_Stmt # OC addition
...
class Continue(Statement):
    ...
    CONTINUE
    """
    f2003_class = Fortran2003.Continue_Stmt # OC addition
...
class Return(Statement):
    ...
    """
    f2003_class = Fortran2003.Return_Stmt # OC addition
...
class Stop(Statement):
    ...
    """
    f2003_class = Fortran2003.Stop_Stmt # OC addition
...
class Print(Statement):
    ...
    """
    f2003_class = Fortran2003.Print_Stmt # OC addition
...
Read1:    READ <format> [, <input-item-list>]
    <format> == <default-char-expr> | <label> | *
    """
    f2003_class = Fortran2003.Read_Stmt # OC addition
...
class Write(Statement):
    ...
    """
    f2003_class = Fortran2003.Write_Stmt # OC addition
...
class Flush(Statement):
    ...
    <flush-spec> = [ UNIT = ] <file-unit-number>
                 ...
                 | ERR = <label>
    """
    f2003_class = Fortran2003.Flush_Stmt # OC addition
...
class Wait(Statement):
    ...
    """
    f2003_class = Fortran2003.Wait_Stmt # OC addition
...
class Contains(Statement):
    ...
    CONTAINS
    """
    f2003_class = Fortran2003.Contains_Stmt # OC addition
...
class Allocate(Statement):
    ...
    """
    f2003_class = Fortran2003.Allocate_Stmt # OC addition
...
class Deallocate(Statement):
    ...
    <dealloc-opt> = STAT = <stat-variable>
                    | ERRMSG = <errmsg-variable>
    """
    f2003_class = Fortran2003.Deallocate_Stmt # OC addition
...
class ModuleProcedure(Statement):
    ...
    """
    f2003_class = Fortran2003.Procedure_Stmt # OC addition
...
class Access(Statement):
    ...
    """
    f2003_class = Fortran2003.Access_Stmt # OC addition
...
class Close(Statement):
    ...
    """
    f2003_class = Fortran2003.Close_Stmt # OC addition
...
class Cycle(Statement):
    ...
    """
    f2003_class = Fortran2003.Cycle_Stmt # OC addition
...
class FilePositioningStatement(Statement):
    ...
    """
    f2003_class = Fortran2003.Rewind_Stmt # OC addition        
...
class Backspace(FilePositioningStatement):
    f2003_class = Fortran2003.Backspace_Stmt # OC addition
    pass

class Endfile(FilePositioningStatement):
    f2003_class = Fortran2003.Endfile_Stmt # OC addition
    pass
...
class Format(Statement):
    ...
    """
    f2003_class = Fortran2003.Format_Stmt # OC addition
...
class Save(Statement):
    ...
    <object-name> = <name>
    """
    f2003_class = Fortran2003.Save_Stmt # OC addition
    ...
    def resolve_uname(self, uname, res_stmt):
        ...
        for item in self.items:
            if item.startswith('/') and item.endswith('/'):
                if str(uname)==item[1:-1]:
                    newname = KGName(pathname(self, item))
...
class Data(Statement):
    ...
    """
    f2003_class = Fortran2003.Data_Stmt # OC addition
...
class Nullify(Statement):
    ...
    """
    f2003_class = Fortran2003.Nullify_Stmt # OC addition
...
class Use(Statement):
    ...
    """
    f2003_class = Fortran2003.Use_Stmt # OC addition
    ...
    def resolve(self, request):
        from oc_state import ResState, SrcFile, State
        from oc_utils import Logger, ProgramException, UserException
        ...
        if self.module is None:
            if State.modules.has_key(self.name):
                ...
                if fn:
                    ...
                    Logger.warn('Module is not found: %s'%self.name)
        ...
        if request.state == ResState.RESOLVED:
            ...
            if self.top.reader.id in State.modfiles:
    ...
    def tooc(self, **kwargs):
        if len(kwargs)>0:
            ...
            return super(Use, self).tooc()

    # end of OC


    #def analyze(self): # OC deletion
    def analyze_org(self): # OC addition
...
class Exit(Statement):
    ...
    """
    f2003_class = Fortran2003.Exit_Stmt # OC addition
...
class Parameter(Statement):
    ...
    """
    f2003_class = Fortran2003.Parameter_Stmt # OC addition
...
class Equivalence(Statement):
    ...
    """
    f2003_class = Fortran2003.Equivalence_Stmt # OC addition
...
class Dimension(Statement):
    ...
    """
    f2003_class = Fortran2003.Dimension_Stmt # OC addition
...
class Target(Statement):
    ...
    """
    f2003_class = Fortran2003.Target_Stmt # OC addition
...
class Pointer(Statement):
    ...
    """
    f2003_class = Fortran2003.Pointer_Stmt # OC addition
...
class Protected(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Protected_Stmt # OC addition
...
class Volatile(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Volatile_Stmt # OC addition
...
class Value(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Value_Stmt # OC addition
...
class ArithmeticIf(Statement):
    ...
    """
    f2003_class = Fortran2003.Arithmetic_If_Stmt # OC addition
...
class Intrinsic(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Intrinsic_Stmt # OC addition
...
class Inquire(Statement):
    ...
    <output-item> = <expr>
                  | <io-implied-do>
    """
    f2003_class = Fortran2003.Inquire_Stmt # OC addition
...
class Sequence(Statement):
    ...
    SEQUENCE
    """
    f2003_class = Fortran2003.Sequence_Stmt # OC addition
...
class External(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.External_Stmt # OC addition
...
class Namelist(Statement):
    ...
    """
    f2003_class = Fortran2003.Namelist_Stmt # OC addition
...
class Common(Statement):
    ...
    <common-block-object> = <variable-name> [ ( <explicit-shape-spec-list> ) ]
                          | <proc-pointer-name>
    """
    f2003_class = Fortran2003.Common_Stmt # OC addition
...
class Optional(StatementWithNamelist):
    ...
    <dummy-arg-name> = <name>
    """
    f2003_class = Fortran2003.Optional_Stmt # OC addition
...
class Intent(Statement):
    ...
    """
    f2003_class = Fortran2003.Intent_Stmt # OC addition
...
class Entry(Statement):
    ...
    """
    f2003_class = Fortran2003.Entry_Stmt # OC addition
...
class Import(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Import_Stmt # OC addition
...
class Forall(Statement):
    ...
    """
    f2003_class = Fortran2003.Forall_Stmt # OC addition
...
class SpecificBinding(Statement):
    ...
    <access-spec> = PUBLIC | PRIVATE
    """
    f2003_class = Fortran2003.Specific_Binding # OC addition
...
class GenericBinding(Statement):
    ...
    """
    f2003_class = Fortran2003.Generic_Binding # OC addition
...
class FinalBinding(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Final_Binding # OC addition
...
class Allocatable(Statement):
    ...
    """
    f2003_class = Fortran2003.Allocatable_Stmt # OC addition
...
class Asynchronous(StatementWithNamelist):
    ...
    """
    f2003_class = Fortran2003.Asynchronous_Stmt # OC addition
...
class Bind(Statement):
    ...
    """
    f2003_class = Fortran2003.Bind_Stmt # OC addition
...
class Else(Statement):
    ...
    """
    f2003_class = Fortran2003.Else_Stmt # OC addition
...
class ElseIf(Statement):
    ...
    """
    f2003_class = Fortran2003.Else_If_Stmt # OC addition
...
class Case(Statement):
    ...
    """
    f2003_class = Fortran2003.Case_Stmt # OC addition
...
class Where(Statement):
    ...
    """
    f2003_class = Fortran2003.Where_Stmt # OC addition
...
class ElseWhere(Statement):
    ...
    """
    f2003_class = Fortran2003.Elsewhere_Stmt # OC addition
    ...
    def tofortran(self, isfix=None):
        tab = self.get_indent_tab(isfix=isfix)
        #s = 'ELSE WHERE' # OC deletion
        s = 'ELSEWHERE' # OC addition
...
class Enumerator(Statement):
    ...
    """
    f2003_class = Fortran2003.Enumerator_Def_Stmt # OC addition
...
class Comment(Statement):
    ...
    """
    f2003_class = Fortran2003.Comment # OC addition
