...
!$opencase SRCGEN(directive: label=100, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=101, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=102, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=103, sentinel=DIR, directive=("UNROLL")*1)
     do i = 1, mgncol
...
!$opencase SRCGEN(directive: label=110, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=111, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=112, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=113, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!$opencase SRCGEN(directive: label=120, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=121, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=122, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=123, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
                    !=================================================================
...
!$opencase SRCGEN(directive: label=130, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=131, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=132, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=133, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
                    !===================================================================
                    ! conservation of nc
                    !-------------------------------------------------------------------
...
!$opencase SRCGEN(directive: label=140, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=141, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=142, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=143, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!$opencase SRCGEN(directive: label=150, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=151, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=152, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=153, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!$opencase SRCGEN(directive: label=160, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=161, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=162, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=163, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!$opencase SRCGEN(directive: label=170, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=171, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=172, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=173, sentinel=DIR, directive=("UNROLL")*1)
     if (do_cldice) then
        do i=1,mgncol
                        ! conservation of qi
                        !-------------------------------------------------------------------
...
!$opencase SRCGEN(directive: label=180, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=181, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=182, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=183, sentinel=DIR, directive=("UNROLL")*1)
     if (do_cldice) then
        do i=1,mgncol
                        ! conservation of ni
                        !-------------------------------------------------------------------
...
!$opencase SRCGEN(directive: label=190, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=191, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=192, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=193, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!$opencase SRCGEN(directive: label=200, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=201, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=202, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=203, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!$opencase SRCGEN(directive: label=210, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!$opencase SRCGEN(directive: label=211, sentinel=DIR, directive=("FORCEINLINE")*1)
!$opencase SRCGEN(directive: label=212, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=213, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!!$opencase SRCGEN(directive: label=220, sentinel=DIR, directive=("DISTRIBUTE POINT")*1)
!!$opencase SRCGEN(directive: label=221, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=222, sentinel=DIR, directive=("SIMD")*1)
!!$opencase SRCGEN(directive: label=223, sentinel=DIR, directive=("UNROLL")*1)
     do i=1,mgncol
...
!!$opencase SRCGEN(directive: label=231, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=233, sentinel=DIR, directive=("UNROLL")*1)
     do k=1,nlev
     ...
     nstep = 1 + int(max( &
          ...
          * deltat)
                ...
                !==============================================================
!!$opencase SRCGEN(directive: label=241, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=243, sentinel=DIR, directive=("UNROLL")*1)
     do n = 1,nstep
        if (do_cldice) then
           falouti  = fi  * dumi(i,:)
     ...
     nstep = 1 + int(max( &
          ...
          * deltat)
                ! loop over sedimentation sub-time step to ensure stability
                !==============================================================
!!$opencase SRCGEN(directive: label=251, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=253, sentinel=DIR, directive=("UNROLL")*1)
     do n = 1,nstep
        faloutc  = fc  * dumc(i,:)
     ...
     nstep = 1 + int(max( &
          ...
          * deltat)
                ! loop over sedimentation sub-time step to ensure stability
                !==============================================================
!!$opencase SRCGEN(directive: label=261, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=263, sentinel=DIR, directive=("UNROLL")*1)
     do n = 1,nstep
        faloutr  = fr  * dumr(i,:)
     ...
     nstep = 1 + int(max( &
          ...
          * deltat)
                ! loop over sedimentation sub-time step to ensure stability
                !==============================================================
!!$opencase SRCGEN(directive: label=271, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=273, sentinel=DIR, directive=("UNROLL")*1)
     do n = 1,nstep
        falouts  = fs  * dums(i,:)
...
!!$opencase SRCGEN(directive: label=281, sentinel=DIR, directive=("FORCEINLINE")*1)
!!$opencase SRCGEN(directive: label=283, sentinel=DIR, directive=("UNROLL")*1)
     do k=1,nlev
